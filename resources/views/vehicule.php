...
&emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;  <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Recherche par le type...">
    ...
    <table class="table table-striped" id="myTable">
        ...
        foreach ($data as $vehicule): ?>
            <tr>
                ...
                <td>
                    <a href="index.php?action=editVehicule&id_vehicule_festival=<?php echo $vehicule->getId_vehicule_festival() ?>" class="btn btn-success btn-sm">Modifier</a>
